...
# Required
parser.add_argument('--cp_save', type=str, default='/media/ubuntun/file/ltw2/20240221-133240_5e-05_linear_PVT_GLenhanceV21_Diff_dim64_Prostate_init', help='experiment name')
...
parser.add_argument("--loadFile", type=str, default='/media/oip/file/ltw2/20240221-133240_5e-05_linear_PVT_GLenhanceV21_Diff_dim64_Prostate_init', help="Name of the .pkl model file to load in. Ex: model_358e_450000s.pkl")
...
parser.add_argument('--dataset_root', type=str, default='/home/oip/data/ProstateSeg/ProstateX', help='note for this run')
...
parser.add_argument('--job_name', type=str, default='bs1_DDPM', help='job_name')
...
def main():
    ...
    device = torch.device("cuda:1" if torch.cuda.is_available() else "cpu")  # 如果有GPU则使用第一块，否则使用CPU
    ...
    with torch.no_grad():  # Turn off gradient
        ...
        for step, (images, masks, index) in enumerate(test_dataloader):
            ...
            for idx in range(images.shape[0]):
                ...
                if predict_rgb.ndim == 2:
                    predict_rgb = torch.unsqueeze(predict_rgb,dim=0)
